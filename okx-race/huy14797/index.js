...
const totalReload = 28
const secondToRefresh = 90
...
class OKX {
    headers() {
        return {
            ...
            "Referer": "https://www.okx.com/mini-app/racer?tgWebAppStartParam=linkCode_5045889481",
                ...
                try {
                    ...
                    while (true) {
                        ...
                        if (assessData.numChance > 0) {
                            ...
                            await this.Countdown((totalReload - assessData.numChance) * secondToRefresh);;
                        }
                    }
                } catch (error) {
